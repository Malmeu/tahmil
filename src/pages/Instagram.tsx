...
export default function Instagram() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!url) {
      toast.error('الرجاء إدخال رابط المنشور');
      return;
    }
    setLoading(true);
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
          <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">مميزات التحميل من انستغرام</h2>
          <ul className="space-y-2 text-gray-600 dark:text-gray-300">
            <li>• تحميل الصور بجودة عالية</li>
            <li>• تحميل الفيديوهات والريلز</li>
            <li>• تحميل القصص والبث المباشر</li>
